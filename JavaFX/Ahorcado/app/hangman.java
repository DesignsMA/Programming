...
public class hangman {
    ...
    void newGame() {
        ...
        do {
            ...
            try {
                do
                    letter = Character.toLowerCase(rd.next().charAt(0));
        ...
        } while (tries > 0 && !hidden.toString().equals(word.toString())); // While there are tries left and the word is
                                                                           // not equal to the guessed
